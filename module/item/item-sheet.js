export default class UAItemSheet extends ItemSheet
{
    ...
    get template() {
        if (game.user.isGM || !this.item.limited) {
            return "systems/unknownarmies/template/item/item-sheet.hbs";
        } else {
            return "systems/unknownarmies/template/item/limited-item-sheet.hbs";
        }
    }
